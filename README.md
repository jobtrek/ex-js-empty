# JavaScript exercises v1.3.6 <!-- x-release-please-version -->
...
```shell
docker run --rm --network host --init -it mcr.microsoft.com/playwright:v1.60.0-noble /bin/sh -c "cd /home/pwuser && npx -y playwright@1.60.0 run-server --port 8080"
```
